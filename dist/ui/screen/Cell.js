 ...
 */
export function packCell(charId, styleId, hyperlinkId, width) {
    return (BigInt.asUintN(32, BigInt(charId)) |
 ...
 */
export function unpackCell(cell) {
    return {

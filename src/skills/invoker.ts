...
export async function loadSkillContent(
  skill: LoadedSkill,
  options: LoadSkillContentOptions
): Promise<{
  content: string;
 ...
 */
export function parseSkillInvocation(input: string): {
  skillName: string;
  args: string[];
} {
 ...
 */
export function shouldHookRun(hook: SkillHookDefinition, toolCall: { name: string; input?: unknown }): boolean {
